...
function MyPlayerHelper:playerClickBlock (objid, blockid, x, y, z)
  ...
  -- body
  BlockHelper:placeBlock(118, x, y + 1, z)
  BlockHelper:placeBlock(118, x + 1, y + 1, z)
  BlockHelper:placeBlock(118, x - 1, y + 1, z)
  BlockHelper:placeBlock(118, x + 2, y + 1, z)
  BlockHelper:placeBlock(118, x - 2, y + 1, z)
  BlockHelper:placeBlock(118, x + 3, y + 1, z)
  BlockHelper:placeBlock(118, x - 3, y + 1, z)
  BlockHelper:placeBlock(118, x + 4, y + 1, z)
  BlockHelper:placeBlock(118, x - 4, y + 1, z)
  BlockHelper:placeBlock(118, x + 5, y + 1, z)
  BlockHelper:placeBlock(118, x - 5, y + 1, z)
  BlockHelper:placeBlock(118, x + 6, y + 1, z)
  BlockHelper:placeBlock(118, x - 6, y + 1, z)
  BlockHelper:placeBlock(118, x + 7, y + 1, z)
  BlockHelper:placeBlock(118, x - 7, y + 1, z)
  BlockHelper:placeBlock(118, 2, 6, 19)
  BlockHelper:placeBlock(118, 3, 6, 19)
  BlockHelper:placeBlock(118, 4, 6, 19)
  BlockHelper:placeBlock(118, 5, 6, 19)
