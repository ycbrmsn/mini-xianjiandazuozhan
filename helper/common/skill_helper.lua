...
function SkillHelper.airArmour (objid, size, time)
  ...
  local idx = 1
  ActorHelper.playBodyEffect(objid, SkillHelper.airArmourData.bodyEffect)
...
function SkillHelper.stopAirArmour (objid)
  ...
  ActorHelper.stopBodyEffectById(objid, SkillHelper.airArmourData.bodyEffect)
end
...
function SkillHelper.huitian (objid, item, num, size, changeAngle, distance)
  ...
  local projectiles = SkillHelper.clearHuitian(objid)
  for i = 1, num do
...
function SkillHelper.clearHuitian (objid)
  local projectiles = SkillHelper.huitianData[objid]
  ...
  SkillHelper.huitianData[objid] = {}
  return SkillHelper.huitianData[objid]
end
...
function SkillHelper.getShunData (objid)
  local data = SkillHelper.shunData[objid]
  if (not(data)) then
    data = {}
    SkillHelper.shunData[objid] = data
  end
  return data
end
