...
function BackpackHelper.getItemNumByShortcut (playerid, itemid)
  return BackpackHelper.getItemNumByBackpackBar(playerid, BACKPACK_TYPE.SHORTCUT, itemid)
end

-- 获取存储栏某个道具总数及背包格数组
function BackpackHelper.getItemNumByInventory (playerid, itemid)
  return BackpackHelper.getItemNumByBackpackBar(playerid, BACKPACK_TYPE.INVENTORY, itemid)
end
