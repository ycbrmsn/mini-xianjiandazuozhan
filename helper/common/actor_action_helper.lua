...
function ActorActionHelper.getApproachData (think, positions, isNegDir, index, restTime, speed)
  local data = ActorActionHelper.getMoveData(think, positions, isNegDir, index, restTime, speed)
  data.style = 'approach'
  return data
end
...
function ActorActionHelper.setFreeInArea (think, actor, posPairs, isAppend)
  ...
  actor.freeInAreaIds = ActorActionHelper.getFreeInAreaIds(posPairs)
  return want
end
...
function ActorActionHelper.playHi (objid, afterSeconds)
  ActorActionHelper.playAct(objid, ActorHelper.ACT.HI, afterSeconds)
end

function ActorActionHelper.playDown (objid, afterSeconds)
  ActorActionHelper.playAct(objid, ActorHelper.ACT.DOWN, afterSeconds)
end

function ActorActionHelper.playSleep (objid, afterSeconds)
  ActorActionHelper.playAct(objid, ActorHelper.ACT.SLEEP, afterSeconds)
end

function ActorActionHelper.playSit (objid, afterSeconds)
  ActorActionHelper.playAct(objid, ActorHelper.ACT.SIT, afterSeconds)
end

function ActorActionHelper.playAttack (objid, afterSeconds)
  ActorActionHelper.playAct(objid, ActorHelper.ACT.ATTACK, afterSeconds)
end

function ActorActionHelper.playFree (objid, afterSeconds)
  ActorActionHelper.playAct(objid, ActorHelper.ACT.FREE, afterSeconds)
end

function ActorActionHelper.playFree2 (objid, afterSeconds)
  ActorActionHelper.playAct(objid, ActorHelper.ACT.FREE2, afterSeconds)
end

function ActorActionHelper.playPoss (objid, afterSeconds)
  ActorActionHelper.playAct(objid, ActorHelper.ACT.POSE, afterSeconds)
end

function ActorActionHelper.playAngry (objid, afterSeconds)
  ActorActionHelper.playAct(objid, ActorHelper.ACT.ANGRY, afterSeconds)
end

function ActorActionHelper.playThink (objid, afterSeconds)
  ActorActionHelper.playAct(objid, ActorHelper.ACT.THINK, afterSeconds)
end

function ActorActionHelper.playDie (objid, afterSeconds)
  ActorActionHelper.playAct(objid, ActorHelper.ACT.DIE, afterSeconds)
end

function ActorActionHelper.playStand (objid, afterSeconds)
  ActorActionHelper.playAct(objid, ActorHelper.ACT.STAND, afterSeconds)
end

function ActorActionHelper.playHappy (objid, afterSeconds)
  ActorActionHelper.playAct(objid, ActorHelper.ACT.HAPPY, afterSeconds)
end

function ActorActionHelper.playThank (objid, afterSeconds)
  ActorActionHelper.playAct(objid, ActorHelper.ACT.THANK, afterSeconds)
end
