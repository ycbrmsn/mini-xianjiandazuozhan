...
function CreatureHelper.getHp (objid)
  return CreatureHelper.getAttr(objid, CREATUREATTR.CUR_HP)
end

-- 获取最大生命值
function CreatureHelper.getMaxHp (objid)
  return CreatureHelper.getAttr(objid, CREATUREATTR.MAX_HP)
end

-- 设置当前生命值
function CreatureHelper.setHp (objid, hp)
  return CreatureHelper.setAttr(objid, CREATUREATTR.CUR_HP, hp)
end

-- 设置最大生命值
function CreatureHelper.setMaxHp (objid, maxHp)
  return CreatureHelper.setAttr(objid, CREATUREATTR.MAX_HP, maxHp)
end
